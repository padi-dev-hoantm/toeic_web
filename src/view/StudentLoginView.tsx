...
import { userId } from "@/recoil/user.recoil";
    ...
    mutateLogin(value, {
      onSuccess: (data) => {
        if (!data.data) {
          ...
          addCookie(data.data);
          router.push(routerConstant.student.result)
        }
      },
    });
  };
      ...
      <div className="pt-[8%] flex justify-center ">
        ...
        <div className="w-[500px] box-shadow-item ">
          <form onSubmit={handleSubmit(handleLogin)} className="bg-[#fff] p-[50px]">
            <h1 className="text-center text-2xl font-bold text-[#4F4F4F]">Thí sinh đăng nhập</h1>
            <Label text="Email:" />
            <InputCommon
              type="text"
              name="email"
